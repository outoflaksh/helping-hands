        ...
        <FormWrapper>
          <FormContent>
            ...
            <form onSubmit={handleSubmit}>
              <FormGroup>
                <input type="text" ref={jobTitleRef} placeholder="Job title; Ex: Construction" />
              </FormGroup>
              <FormGroup>
                <input type="text" ref={jobLocationRef} placeholder="Job location; Ex: ABC School" />
                <input type="text" ref={jobAddressRef} placeholder="Job address" />
              </FormGroup>
              <FormGroup>
                <input type="text" ref={contactNumberRef} placeholder="Contact number" />
              </FormGroup>
              <FormGroup>
